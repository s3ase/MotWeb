...
if(!cff_js_exists){
	...
	function cff_init(){
		...
		jQuery('.cff-likebox iframe').each(function(){
			...
			$likebox.attr('src', 'https://web.archive.org/web/20250410100619/https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F'+$likebox.attr('data-likebox-id')+'%2F&tabs&width='+Math.floor(likeboxWidth)+'&small_header='+$likebox.attr('data-likebox-header')+'&adapt_container_width=true&hide_cover='+$likebox.attr('data-hide-cover')+'&hide_cta='+$likebox.attr('data-hide-cta')+'&show_facepile='+$likebox.attr('data-likebox-faces')+'&locale='+$likebox.attr('data-locale'));
		});
		*/
			...
			function cffLinkHashtags(){
				...
				function replacer(hash){
					...
					if ( /^#[0-9A-F]{6}$/i.test( replacementString ) ){
						...
						return ' <a href="https://web.archive.org/web/20250410100619/https://www.facebook.com/hashtag/'+ replacementString.substring(1) +'" target="_blank" rel="nofollow" style="color:#' + linkcolor + '">' + replacementString + '</a>';
					}
				}
...
/*
     FILE ARCHIVED ON 10:06:19 Apr 10, 2025 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 05:59:44 Oct 27, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 18.653
  LoadShardBlock: 80.27 (3)
  PetaboxLoader3.datanode: 128.199 (5)
  PetaboxLoader3.resolve: 166.217 (2)
  load_resource: 228.542
  loaddict: 33.228
*/